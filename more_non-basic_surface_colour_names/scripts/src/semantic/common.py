...
# Extended to include common color names from XKCD dataset
BASIC_COLORS = {
    ...
    # Missing high-frequency colors from XKCD validation
    'periwinkle', 'mocha', 'camel', 'marigold', 'mustard', 'mahogany',
    'puce', 'ecru', 'sepia', 'vermillion', 'vermilion', 'cerise',
    'carnation', 'tangerine', 'persimmon', 'papaya', 'mango',
    'canary', 'lemon', 'flax', 'goldenrod', 'saffron', 'honey',
    'pear', 'pistachio', 'avocado', 'shamrock', 'clover', 'juniper',
    'pine', 'spruce', 'seaweed', 'seafoam', 'spearmint', 'eucalyptus',
    'ocean', 'peacock', 'arctic', 'denim', 'cornflower', 'bluebell',
    'periwinkle', 'wisteria', 'amethyst', 'orchid', 'heather',
    'mulberry', 'eggplant', 'aubergine', 'boysenberry', 'raspberry',
    'strawberry', 'watermelon', 'bubblegum', 'flamingo', 'blush',
    'rouge', 'brick', 'cayenne', 'paprika', 'cinnamon', 'ginger',
    'caramel', 'butterscotch', 'toffee', 'chocolate', 'cocoa', 'coffee',
    'espresso', 'walnut', 'chestnut', 'hazelnut', 'almond', 'peanut',
    'sand', 'wheat', 'oatmeal', 'mushroom', 'stone', 'pewter', 'steel',
    'ash', 'smoke', 'fog', 'mist', 'cloud', 'snow', 'pearl', 'bone',
    # Nature/object colors commonly used
    'sky', 'sea', 'grass', 'leaf', 'moss', 'lichen', 'clay', 'mud',
    'dirt', 'earth', 'soil', 'bark', 'wood', 'leather', 'suede'
}
