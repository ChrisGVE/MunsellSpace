...
pub const ISCC_NBS_COLORS: &[IsccNbsColorEntry] = &[
    ...
    IsccNbsColorEntry { color_number: 115, iscc_nbs_color_name: "yellow green", iscc_nbs_formatter: Some("vivid {0}"), alt_color_name: "chartreuse", color_shade: "chartreuse" },
    IsccNbsColorEntry { color_number: 116, iscc_nbs_color_name: "yellow green", iscc_nbs_formatter: Some("brilliant {0}"), alt_color_name: "chartreuse", color_shade: "chartreuse" },
    IsccNbsColorEntry { color_number: 117, iscc_nbs_color_name: "yellow green", iscc_nbs_formatter: Some("strong {0}"), alt_color_name: "chartreuse", color_shade: "chartreuse" },
    IsccNbsColorEntry { color_number: 118, iscc_nbs_color_name: "yellow green", iscc_nbs_formatter: Some("deep {0}"), alt_color_name: "chartreuse", color_shade: "chartreuse" },
    IsccNbsColorEntry { color_number: 119, iscc_nbs_color_name: "yellow green", iscc_nbs_formatter: Some("light {0}"), alt_color_name: "chartreuse", color_shade: "chartreuse" },
    IsccNbsColorEntry { color_number: 120, iscc_nbs_color_name: "yellow green", iscc_nbs_formatter: Some("moderate {0}"), alt_color_name: "chartreuse", color_shade: "chartreuse" },
    IsccNbsColorEntry { color_number: 121, iscc_nbs_color_name: "yellow green", iscc_nbs_formatter: Some("pale {0}"), alt_color_name: "chartreuse", color_shade: "chartreuse" },
    IsccNbsColorEntry { color_number: 122, iscc_nbs_color_name: "yellow green", iscc_nbs_formatter: Some("grayish {0}"), alt_color_name: "chartreuse", color_shade: "chartreuse" },
